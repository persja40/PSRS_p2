...
#define GASNETI_BUILD_ID "Sun Apr 29 08:09:04 CEST 2018 ernest"
#define GASNETI_CONFIGURE_ARGS "'--disable-psm' '--disable-mxm' '--disable-portals4' '--disable-ofi' '--disable-parsync'"
